...
public class ArrayBasedQueue {
	...
	/**
	 * Since it is a queue, we need track of both head and tail Initial values to be
	 * 0
	 */
	int head = 0;
	int tail = 0;
	...
	/**
	 * Method to push a new item in queue We will deal only with tail while adding
	 * new item
	 * 
	 * @param item
	 */
	...
	/**
	 * Method to pop a item from queue We will deal only with head while deleting a
	 * element
	 * 
	 * @return {@link Object}
	 */
