...
public class CircularLinkedList<E> {
	...
	/*
	 * Size to keep track of number of elements in list. This should be increased by
	 * 1 when a element is added and should be reduced by 1 when a element is
	 * deleted
	 */
	private int size = 0;
	...
	/**
	 * Method to delete an element from the beginning of the circular linked list
	 */
	...
	/**
	 * Method to delete an item from the circular linked list at a given position
	 * 
	 * @param position
	 */
	...
	/**
	 * Node class of a circular linked list This is needed since entire linked list
	 * is a collection of nodes connected to each other through links
	 * 
	 * <br>
	 * We are keeping it generic so that it can be used with Integer, String or
	 * something else </br>
	 * 
	 * <br>
	 * Each node contains a data item and pointer to next node. Since this is a
	 * Circular linked list and each node points in one direction, we maintain only
	 * pointer to one (next) node. Last node again points to the first node </br>
	 * 
	 * @author Deepak
	 *
	 * @param <T>
