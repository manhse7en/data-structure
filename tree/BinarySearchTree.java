...
public class BinarySearchTree<E extends Comparable<E>> {
	...
	/*
	 * We will maintain root and size of the tree. Size here means number of nodes
	 * in the tree
	 */
	private Node<E> root;
	...
	public void addNode(E value) {
		/*
		 * If root is null, make a new node and insert at root, else insert in tree
		 */
		if (root == null) {
	...
	private Node<E> addNode(Node<E> root, E value) {
		...
		/*
		 * Compare the values and check if we need to insert in left subtree or right
		 * subtree
		 */
	...
	/*
	 * There are 3 cases here, 1. Node to be removed has no child 2. Node to be
	 * removed has one child 3. Node to be removed has two child
	 */
